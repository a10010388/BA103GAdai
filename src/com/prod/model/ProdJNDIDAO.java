...
public class ProdJNDIDAO implements ProdDAO_interface {
	...
	private static final String UPDATE = "UPDATE PROD SET " + "STORE_NO =?," + "PROD_NAME =?," + "BEAN_TYPE =?,"
			+ "BEAN_GRADE =?," + "BEAN_CONTRY =?," + "BEAN_REGION =?," + "BEAN_FARM =?," + "BEAN_FARMER =?,"
			+ "BEAN_EL =?," + "PROC =?," + "ROAST =?," + "BEAN_ATTR_ACID =?," + "BEAN_ATTR_AROMA =?,"
			+ "BEAN_ATTR_BODY =?," + "BEAN_ATTR_AFTER =?," + "BEAN_ATTR_BAL =?," + "BEAN_AROMA =?," + "PROD_PRICE =?,"
			+ "PROD_WT =?," + "SEND_FEE =?," + "PROD_SUP =?," + "PROD_CONT =?," + "PROD_PIC1 =?," + "PROD_PIC2 =?,"
			+ "PROD_PIC3 =?," + "PROD_STAT =?," + "ED_TIME =?" + "WHERE PROD_NO =?";
	...
	private static final String GET_ALL_NO_IMG_STMT = "SELECT " + "PROD_NO," + "STORE_NO," + "PROD_NAME," + "BEAN_TYPE,"
			+ "BEAN_GRADE," + "BEAN_CONTRY," + "BEAN_REGION," + "BEAN_FARM," + "BEAN_FARMER," + "BEAN_EL," + "PROC,"
			+ "ROAST," + "BEAN_ATTR_ACID," + "BEAN_ATTR_AROMA," + "BEAN_ATTR_BODY," + "BEAN_ATTR_AFTER,"
			+ "BEAN_ATTR_BAL," + "BEAN_AROMA," + "PROD_PRICE," + "PROD_WT," + "SEND_FEE," + "PROD_SUP," + "PROD_CONT,"
			+ "PROD_STAT," + "ED_TIME " + "FROM PROD";
	...
	private static final String GET_ONE_NO_IMG_STMT = "SELECT " + "STORE_NO," + "PROD_NAME," + "BEAN_TYPE,"
			+ "BEAN_GRADE," + "BEAN_CONTRY," + "BEAN_REGION," + "BEAN_FARM," + "BEAN_FARMER," + "BEAN_EL," + "PROC,"
			+ "ROAST," + "BEAN_ATTR_ACID," + "BEAN_ATTR_AROMA," + "BEAN_ATTR_BODY," + "BEAN_ATTR_AFTER,"
			+ "BEAN_ATTR_BAL," + "BEAN_AROMA," + "PROD_PRICE," + "PROD_WT," + "SEND_FEE," + "PROD_SUP," + "PROD_CONT,"
			+ "PROD_STAT," + "ED_TIME " + "FROM PROD " + "WHERE PROD_NO =?";
