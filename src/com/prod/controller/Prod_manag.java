	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				String url = "/FrontEnd/store_mag/get_oneprod.jsp";
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/FrontEnd/store_mag/listAllpro_bystore.jsp");
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req
							.getRequestDispatcher("/FrontEnd/store_mag/get_oneprod.jsp");
					failureView.forward(req, res);
					return; // 程式中斷
				}
				/*************************** 2.開始修改資料 *****************************************/
				...
				String url = "/FrontEnd/store_mag/listAllpro_bystore.jsp";
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/FrontEnd/store_mag/get_oneprod.jsp");
				failureView.forward(req, res);
			}
		}
