...
<body>
	...
	<FORM METHOD="POST" ACTION="<%=request.getContextPath()%>/store/ToStore.do" name="form1" 
		...
		<table border="1">
			...
			<tr>
				<td>店家住址:</td>
				<td><input type="TEXT" id="address" name="store_add" size="45" class="add"
					value="中壢市中大路300號" /></td>
				</td>
		...
		<br> <input type="hidden" name="action" value="insert"> 
			 ...
			 <input type="hidden" name="store_add_lat" id="lat" size="45"
					value="" />
			 <input type="hidden" name="store_add_lon" id="lng" size="45"
					value="" />
...
document.getElementById('idpic1').addEventListener('change', handleFileSelect1, false);
...
document.getElementById('stpic1').addEventListener('change', handleFileSelect2, false);
...
document.getElementById('stpic2').addEventListener('change', handleFileSelect3, false);
...
document.getElementById('stpic3').addEventListener('change', handleFileSelect4, false);
