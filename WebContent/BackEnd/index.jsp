    ...
    <div class="container card">
      <div class="row">
        <div class="col-xs-2 left"><a class="h3 title act" href="#action" aria-expanded="false" aria-controls="action" data-toggle="collapse" style="text-decoration: none;">
            ...
            <ul class="collapse" id="mem"><a>會員資料管理</a><a href="<%=request.getContextPath()%>/BackEnd/store/listAllStore.jsp">廠商店家授權</a><a>積分管理</a></ul></a><a class="h3 title" href="#admin" aria-expanded="false" aria-controls="admin" data-toggle="collapse" style="text-decoration: none;">
            ...
            <ul class="collapse" id="gift"><a>廣告管理</a><a>兌換贈品管理</a><a>兌換贈品業務管理</a></ul></a></div>
